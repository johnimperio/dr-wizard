...
<template>
  <div class="w-full md:w-1/2 md:ml-10 md:p-0 p-4 text-base">
    ...
    <form @submit.prevent="requireInput">
      ...
      <br>
      <label for="clientDetails">8. Please list other clients and event IDs that this is happening for</label>
      <textarea v-model='clientDetails' class="block mt-3 mb-3 w-full h-15 p-2" name="clientDetails" placeholder="Add details here"></textarea>
    </form>
